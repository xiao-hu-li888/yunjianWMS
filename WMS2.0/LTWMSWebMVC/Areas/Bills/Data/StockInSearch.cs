...
namespace LTWMSWebMVC.Areas.Bills.Data
{
    public class StockInSearch
    {
        ...
        public DateTime? s_in_date_begin { get; set; }
        /// <summary>
        /// 出库日期
        /// </summary>
        [Display(Name = "结束日期"), DataType(DataType.Date)]
        public DateTime? s_in_date_end { get; set; }

        /// <summary>
        /// 单据进行状态
        /// </summary>
        [Display(Name = "进行状态"), DropDownList("SearchBillsStatus_In", true)]
        public SearchBillsStatus_In? s_bill_status { get; set; }

 
        public List<StockInModel> PageCont { get; set; }
