...
{
    public class WMSSrv_DealSend : IThreadService
    {
        public Guid Wcs_srv_guid;
        public string ServerName;
        Srv_DealSend wcsdsServer;
        /// <summary>
        /// 服务终止线程退出标志
        /// </summary>
        ...
        public void ThreadStart(object threadhandler)
        {
            ...
            wcsdsServer = new Srv_DealSend(thd.Wcs_srv_guid, thd.Name, thd.Ip, LTLibrary.ConvertUtility.ToInt(thd.Port));
                        ...
                        {//递归执行任务 
                            try
                            {
                                ...
                                foreach (wh_warehouse item in ListWareHouse)
                                {
                                    ...
                                    /////////////////////// 
                                    wcsdsServer.DealSendHandler(item);
                                    /////////////////////// 
                                    if (exitServer)
                                    {
                                        break;
