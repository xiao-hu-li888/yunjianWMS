...
namespace LTProtocol.Tcp
{
    ...
    public class Socket_Server_New
    { //接收绑定事件
        public delegate void ReceiveDelegate(Socket_Server_New socket, string socketKey, string json);
        ...
        public Socket_Server_New(string ServerIp, int Port, SocketClientEncoding encoding)
        {
        ...
        public void StartListen(Socket LastSocketSrv)
        {
            ...
            if (failResend != null)
            {
                ...
                {
                    LogV("终止Socket_Server_New--->>>ReSendAll线程异常:" + ex.Message);
                }
            }
            if (mainTrd != null)
            {
                ...
                {
                    LogV("终止Socket_Server_New--->>>RunAccept线程异常:" + ex.Message);
                }
            }
